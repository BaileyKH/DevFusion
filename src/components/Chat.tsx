...
export const Chat = () => {
    ...
    const isProbablyCode = (text: string): boolean => {
        ...
        const containsCodeIndicators = codeIndicators.some((indicator) =>
        ...
        <div className="w-full h-screen flex flex-col">
            ...
            >
                {messages.map((message) => {
                    const messageUser = Array.isArray(message.user)
                        ? message.user[0]
                        : message.user;
            ...
            <div className="flex-none relative">
                <form
                    ...
                    className="border-t-2 border-darkAccent/65 flex items-center py-4"
                >
                    <textarea
