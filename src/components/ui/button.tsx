...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-primAccent text-slate-50 shadow hover:bg-red-950/90 dark:text-slate-900 dark:hover:bg-slate-50/90",
        destructive:
          "bg-red-500 text-slate-50 shadow-sm hover:bg-red-500/90",
        outline:
          "border border-primAccent bg-red shadow-sm hover:bg-red-100 hover:text-red-900",
        secondary:
          "bg-red-100 text-primDark shadow-sm hover:bg-red-100/80",
        ghost: "hover:bg-red-100 hover:text-primAccent",
