                ...
                {commits.map((commit: any, index: number) => (
                  ...
                  >
                    <div className="flex items-center mb-2">
                      ...
                      <h3 className="font-bold text-lightAccent">{commit.commit.author.name}</h3>
                    </div>
                    <p className="text-lightAccent/85 text-sm mb-1">
                      <strong className='text-lightAccent'>Date:</strong> {new Date(commit.commit.author.date).toLocaleDateString()}
                    </p>
                    <p className="text-lightAccent/85 text-sm mb-2">
                      <strong className='text-lightAccent'>Message:</strong> {commit.commit.message}
                    </p>
                    <a
