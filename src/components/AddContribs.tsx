...
export const AddContribs = ({ projectId }: AddContributorProps) => {
    ...
    const handleSearch = async () => {
        const { data, error } = await supabase
            ...
            .or(
                `username.ilike.%${usernameOrEmail}%,email.ilike.%${usernameOrEmail}%`
            );
    ...
    return (
        <div className="flex flex-col items-center justify-start min-h-screen pt-12 px-4">
            <div className="text-center">
                ...
                >
                    Add collaborators to your project. Teamwork makes the dream
                    work!
                </motion.p>
            </div>
                        ...
                        >
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                    <p className="text-lightAccent font-medium">
                                        {result.username}
                                    </p>
                                </div>
                            </div>
                            <Button
                                onClick={() =>
                                    handleInviteContributor(result.id)
                                }
