        ...
        <div className="flex h-full">
            {isSidebarOpen && (
                ...
                >
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-3xl font-bold text-primAccent">
                            Invitations
                        </h2>
                        <Button
                    ...
                    {pendingInvitations.length === 0 ? (
                        ...
                        <div className="space-y-4 overflow-y-auto">
                            {pendingInvitations.map((invite) => (
                                ...
                                >
                                    <h3 className="text-lg font-semibold text-lightAccent mb-2">
                                        {invite.projects.name}
                                    </h3>
                                    <p className="text-sm text-lightAccent/80 mb-3">
                                        Invited by{" "}
                                        <span className="text-primAccent font-semibold">
            ...
            <div className="flex-grow p-4">
                <div className="flex justify-between items-center mb-8">
                    <h1 className="text-4xl font-extrabold text-primAccent">
                        Your Projects
                    </h1>
                    <Button
