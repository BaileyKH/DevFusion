    ...
    useEffect(() => {
        const fetchProjectMembers = async () => {
          ...
          `
                ...
                console.error(
                    "Unexpected error fetching project members:",
                    error
                );
            }
        };
        ...
        <div className="h-full">
                                        ...
                                        >
                                            ...
                                            >
                                                <NavLink to={`/dashboard`}>
                                                    <div className="project-nav-ico transition duration-200 ease-in hover:text-primAccent mb-16">
                                                        <IconCaretLeft
                                                            stroke={2}
                                                        ...
                                                        {members.map(
                                                            (member) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <p className="font-medium text-white/85 text-sm">
                                                                        {
                                                                            member
                                                                                .users
                                                                                .username
                                                ...
                                                <div>
                                                    {user?.id ===
                                                        ...
                                                        <li>
                                                            ...
                                                            >
                                                                <div className="project-nav-ico text-xs bg-primAccent hover:bg-blue-800 border-none p-2 w-max rounded-md transition duration-300">
                                                                    <IconSquarePlus
                                                                        stroke={
                                                                            2
                                                                        }
            ...
            <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-primDark px-4 py-4 shadow-sm sm:px-6 lg:hidden">
                <button
                    ...
                    className="-m-2.5 p-2.5 text-white/85 lg:hidden"
                >
                    <span className="sr-only">Open sidebar</span>
                    <IconMenu2 aria-hidden="true" className="h-6 w-6" />
                </button>
                <div className="flex-1 text-sm/6 font-semibold text-white/85">
                    Dashboard
                </div>
