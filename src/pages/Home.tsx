...
export const Home = () => {
    ...
    return (
        <main className="">
            <section className="relative flex flex-col md:flex-row h-auto md:h-screen w-full items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-[#121212] to-[#0d0d0d] text-lightAccent gap-y-8 md:gap-x-14 p-6 md:p-0 lg:px-10">
                <div className="w-full md:w-1/2 flex justify-center items-center mb-8 md:mb-0 lg:justify-end lg:items-start">
                    <div className="h-full w-full max-w-[36rem] items-center justify-center overflow-hidden pt-8 md:pt-0 z-10 md:px-10 lg:px-0">
                        <BoxReveal boxColor={"#0398fc"} duration={1}>
                            <motion.p
                                className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#0398fc] to-[#00c6ff] neon-shadow"
                        ...
                        <BoxReveal boxColor={"#0398fc"} duration={1}>
                            <motion.h2
                                className="mt-4 md:mt-6 text-lg sm:text-xl md:text-2xl text-lightAccent/90 tracking-wider leading-tight"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                        ...
                        <BoxReveal boxColor={"#0398fc"} duration={1}>
                            <motion.div
                                className="mt-6 sm:mt-8 md:mt-10 space-y-3 sm:space-y-4 text-lightAccent text-sm sm:text-md md:text-lg leading-relaxed tracking-wide"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                        ...
                        <BoxReveal boxColor={"#0398fc"} duration={0.5}>
                            <Link to="/auth">
                                ...
                                >
                                    <Button className="mt-6 sm:mt-8 md:mt-12 py-3 sm:py-4 md:py-5 px-6 sm:px-8 md:px-10 lg:px-12 bg-gradient-to-r from-[#0398fc] to-[#00c6ff] text-sm sm:text-md md:text-lg tracking-wider shadow-lg transform hover:shadow-primAccent hover:bg-gradient-to-r hover:from-[#00c6ff] hover:to-[#0398fc] transition-all duration-300">
                                        Get Started
                                    </Button>
                                </motion.div>
                            </Link>
                ...
                <div className="w-full md:w-1/2 flex justify-center md:justify-start items-center relative">
                    <motion.div
                        className="absolute -top-16 -left-16 md:-top-28 md:-left-24 lg:-top-32 lg:-left-24 h-[180px] w-[180px] md:h-[250px] md:w-[250px] lg:h-[300px] lg:w-[300px] rounded-full bg-gradient-to-br from-[#00c6ff] to-[#0398fc] blur-xl md:blur-2xl lg:blur-3xl opacity-40"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 0.5 }}
                    ...
                    <motion.img
                        src={code}
                        className="max-w-[80%] md:max-w-[95%] lg:max-w-[500px] xl:max-w-[700px] rounded-lg shadow-2xl z-10"
                        initial={{ scale: 1.1 }}
                        animate={{ scale: 1 }}
                        transition={{ duration: 1, ease: "easeInOut" }}
                    />
                    <motion.div
                        className="absolute -bottom-10 right-[-50px] md:bottom-[-30px] md:right-[-60px] lg:bottom-[-50px] lg:right-[-100px] h-[120px] w-[120px] md:h-[170px] md:w-[170px] lg:h-[200px] lg:w-[200px] rounded-full bg-gradient-to-tr from-[#00c6ff] to-[#00e4ff] blur-xl md:blur-2xl lg:blur-3xl opacity-50"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 0.3 }}
                        transition={{ duration: 1.5, delay: 1 }}
                    />
                    <motion.div
                        className="absolute -bottom-10 left-10 md:-bottom-20 md:left-20 h-[80px] w-[80px] md:h-[130px] md:w-[130px] lg:h-[150px] lg:w-[150px] rounded-full bg-gradient-to-br from-[#00e4ff] to-[#0398fc] blur-lg md:blur-xl lg:blur-2xl opacity-40"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 0.3 }}
